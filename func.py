...
def helper_1(option, query_vector):
    ...
    if option == "Binary Weighting Scheme":
        ...
        print("Raw Count Weighting Scheme")
        ...
        print("Term Frequency Weighting Scheme")
        ...
        print("Log Normalization Weighting Scheme")
        ...
        print("Double Normalization Weighting Scheme")    
